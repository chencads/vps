...
<a href="https://www.vultr.com/"><img src="https://www.vultr.com/media/banner_2.png" width="468" height="60"></a>
...
Use the *./install.sh* script with the desired crypto and masternode count as parameters, e.g. to install 4 CADS masternodes:
...
Run it after you finished configuration, e.g. after a CADS installation do.

```
/usr/local/bin/activate_masternodes_cads
```     
...
To make this a bit easier for large installations, i implemented a small gimmick in the newest version. Now after the script has run, a partial of the "masternode.conf" file is generated and placed on the VPS eg for XIOS at "/tmp/cads_masternode.conf"
